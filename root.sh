...
pacman -S --noconfirm alsa-utils mesa\
 ...
 i3-gaps i3status dmenu thunar dunst feh terminator kitty picom ranger okular maim i3blocks lxappearance\
 pinta ueberzug tumbler ffmpegthumbnailer\
 noto-fonts noto-fonts-cjk noto-fonts-emoji terminus-font ttf-liberation ttf-roboto ttf-roboto-mono ttf-jetbrains-mono\
